        ...
        <div className="px-6 py-9 md:px-8 md:pt-12 md:pb-24 bg-gradient my-16 md:my-32">
            <div className="grid grid-flow-row auto-rows-max md:grid-cols-2 md:mt-6">
                <div className='md:align-text-middle md:ml-12'>
                    <p className="mx-auto mb-4 font-bold text-3xl text-center md:text-5xl md:text-left md:my-auto text-primary-300/80 md:text-primary-300">
                        Buat undangan dengan mudah
                    </p>
                    <p className='mx-auto text-center md:text-2xl md:text-left md:mt-10 md:mb-12 text-primary-200'>
                        Beberapa hal yang didapatkan ketika menggunakan layanan <span className='font-bold'>Wedding <span className='text-light-pink'>Invitation</span> Digital</span>
                    </p>
                    <ul className='text-primary-200 mt-4 ml-4 md:ml-0 md:text-left'>
                        <li className='flex flex-row mt-2 md:mt-4'>
