...
const Register = () =>{
    ...
    const [isInputValid, setInputValid] = useState({username : true, password: true, phone_number:true, email:true, password_confirmation:true});
    ...
    return(
        <div className='bg-auth' style={{top: '0', left: '0', overflowY: 'auto', overflowX: 'hidden'}}>
            <div className='grid mt-32 grid-cols-1 md:grid-cols-2 gap-8'>
                ...
                <div className='flex justify-center'>
                    ...
                    <h1 className=' text-2xl md:text-3xl text-white font-bold text-center'>Halaman Register</h1>
                        ...
                        {!isInputValid.phone_number && <div className='text-red-500 font-md block'>*This fill is required</div>}
                        ...
                        <div className='flex mt-6'>
                            ...
                            onChange={(pass_conf)=> setPasswordConfirmation(pass_conf.target.value)} 
