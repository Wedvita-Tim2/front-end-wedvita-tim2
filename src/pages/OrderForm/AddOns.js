...
const AddOns= () =>{
    ...
    return(
        <div className="py-4 flex flex-wrap justify-center md:justify-start lg:flex-row lg:justify-between md:mt-4">
            <div>
            ...
            <div className="flex flex-wrap md:flex-col justify-center md:justify-start lg:mx-auto">
                <p className="text-normal md:text-left text-primary-300 font-semibold text-center md:text-2xl md:mb-2 w-64">Form Gift</p>
