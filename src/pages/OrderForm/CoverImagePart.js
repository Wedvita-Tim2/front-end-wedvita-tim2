  ...
  return (
    <div className="image-cropper relative">
      ...
      <div className="w-[340px] h-[340px]  md:w-[450px] md:h-[450px] absolute">
        ...
        />
        <Button onClick={handleCrop} className="z-[999999] absolute top-0 left-0" isPrimary>Crop Image</Button>
        <Button onClick={handleCancel} className="z-[999999] absolute top-0 right-9" isPrimary>Cancel</Button>
      </div>
      )}
      {(preview && result) &&(
        <div className="relative h-28 w-48 md:h-48 md:w-80 rounded-md mt-2"> 
            ...
            <Button type={'button'} 
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="#FF4EB8" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 stroke-primary-200">
